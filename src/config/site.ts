...
import { LayoutDashboard, CalendarCheck, Star, Mail, LibraryBig, Users, FileText, BookOpen, Package, HelpCircle, MessageSquare, Award, CalendarDays, Clock } from "lucide-react";
...
export const siteConfig = {
  ...
  adminNav: [
    ...
    { title: "Manage Availability", href: "/admin/availability", icon: Clock },
