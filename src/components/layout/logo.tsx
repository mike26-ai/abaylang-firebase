  ...
  return (
    <Link href="/" className={`flex items-center ${className}`}>
        ...
        <g id="Abylang-Logo">
            ...
            <text x="75" y="285" fill="#C87546" fontFamily="Georgia, 'Times New Roman', serif" fontSize="18" fontWeight="normal" letterSpacing="1" textAnchor="middle" className="group-[.footer-logo]:fill-[hsl(var(--primary))]">
              ABYLANG
            </text>
        </g>
        </svg>
