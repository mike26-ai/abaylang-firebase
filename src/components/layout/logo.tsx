...
export function Logo({ className = "" }: LogoProps) {
  // Conditionally render the text based on the className.
  // The navbar uses "main-logo", so the text will not render there.
  // The footer uses "footer-logo", so it will render.
      ...
      >
        ...
        <g id="Abylang-Logo">
          <path
            fillRule="evenodd"
            fill="#2E3A40"
            className="group-[.footer-logo]:fill-[hsl(var(--primary-foreground))]"
          ...
          {showText && (
            <text
              ...
              letterSpacing="1"
              textAnchor="middle"
              className="group-[.footer-logo]:fill-[hsl(var(--primary))]"
            >
              ABYLANG
            </text>
          )}
