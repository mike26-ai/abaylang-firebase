...
class TransactionsResource extends base_1.BaseResource {
    list(queryParams) {
        const queryParameters = new base_1.QueryParameters(queryParams);
        return new entities_1.TransactionCollection(this.client, TransactionPaths.list + queryParameters.toQueryString());
    }
    ...
    update(transactionId, updateTransaction, queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = new base_1.QueryParameters(queryParams);
            const urlWithPathParams = new base_1.PathParameters(TransactionPaths.update, {
    ...
    get(transactionId, queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = new base_1.QueryParameters(queryParams);
            const urlWithPathParams = new base_1.PathParameters(TransactionPaths.get, {
                transaction_id: transactionId,
            }).deriveUrl();
    ...
    getInvoicePDF(transactionId, queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = new base_1.QueryParameters(queryParams);
            const urlWithPathParams = new base_1.PathParameters(TransactionPaths.getInvoicePDF, {
                transaction_id: transactionId,
            }).deriveUrl();
            const response = yield this.client.get(urlWithPathParams + queryParameters.toQueryString());
            const data = this.handleResponse(response);
            return new entities_1.TransactionInvoicePDF(data);
        });
    }
    preview(previewTransactionParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = this.handleResponse(response);
            return new entities_1.TransactionPreview(data);
        });
    }
}
