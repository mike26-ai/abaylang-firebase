...
class ProductsResource extends base_1.BaseResource {
    list(queryParams) {
        const queryParameters = new base_1.QueryParameters(queryParams);
        return new entities_1.ProductCollection(this.client, ProductPaths.list + queryParameters.toQueryString());
    }
    create(createProductParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new entities_1.Product(data);
        });
    }
    get(productId, queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameters = new base_1.QueryParameters(queryParams);
            const urlWithPathParams = new base_1.PathParameters(ProductPaths.get, {
    ...
    update(productId, updateProduct) {
        return __awaiter(this, void 0, void 0, function* () {
            const urlWithPathParams = new base_1.PathParameters(ProductPaths.update, {
                product_id: productId,
            }).deriveUrl();
