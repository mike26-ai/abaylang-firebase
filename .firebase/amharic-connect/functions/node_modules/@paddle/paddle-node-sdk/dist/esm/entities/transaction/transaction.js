import { BillingDetails, TransactionsTimePeriod, TransactionItem, TransactionDetails, TransactionPaymentAttempt, TransactionCheckout, Address, TransactionAdjustment, AdjustmentTotals, Business, Customer, Discount, } from '../index';
export class Transaction {
    constructor(transaction) {
        ...
        this.adjustments = transaction.adjustments
            ? (_a = transaction.adjustments) === null || _a === void 0 ? void 0 : _a.map((adjustment) => new TransactionAdjustment(adjustment))
            : null;
